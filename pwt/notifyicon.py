...
class NotifyIcon(Window):
    def __init__(self, hoverText, icon):
        ...
        self.hWindow = win32gui.CreateWindow(classAtom, self.window_class_name, style,
    ...
    def draw_icon(self, icon):
        ...
        if os.path.isfile(icon):
            ...
            logging.warning('Could not find icon file - using default.')
        ...
        self.notify_id = (self.hWindow, 0, win32gui.NIF_ICON | win32gui.NIF_MESSAGE | win32gui.NIF_TIP,
    ...
    def show_balloon(self, balloontext, balloontitle):
        ...
        nid = (self.hWindow, 0 ,
        	...
        	win32con.WM_USER+20, self.hicon, self.hoverText, balloontext, 1, balloontitle,
        	win32gui.NIIF_INFO) 
