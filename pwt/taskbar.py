...
class Taskbar(object):
    def __init__(self):
        ...
        self.appbarData = APPBARDATA(
            ctypes.sizeof(APPBARDATA), self.taskbar.hWindow, 0, 0,
            RECT(0, 0, 0, 0), 0 )
    ...
    def show(self):
        ...
        '''
        self.taskbar.show()
        if(self.startbutton != None):   # for windows 8 compatbility
    ...
    def get_state(self):
        ...
        '''
        return ctypes.windll.shell32.SHAppBarMessage(4, ctypes.byref(self.appbarData))
    ...
    def autohide_on(self):
        ...
        ctypes.windll.shell32.SHAppBarMessage(10, ctypes.byref(self.appbarData))
    ...
    def get_startbutton(self):
        ...
        try:
            ...
            return Window(win32gui.FindWindowEx(desktop, None, 'button', None))
